...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_DIyer')
	 Begin 
	  Alter Database [Assignment07DB_DIyer] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_DIyer;
	 End
	Create Database Assignment07DB_DIyer;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_DIyer;
